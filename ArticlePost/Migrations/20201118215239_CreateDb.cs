    ...
    public partial class CreateDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentAndLike", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CommentAndLike_Article_ArticleID",
                        column: x => x.ArticleID,
                        principalTable: "Article",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentAndLike_User_UserID",
                        column: x => x.UserID,
                        principalTable: "User",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentAndLike_ArticleID",
                table: "CommentAndLike",
                column: "ArticleID");

            migrationBuilder.CreateIndex(
                name: "IX_CommentAndLike_UserID",
                table: "CommentAndLike",
                column: "UserID");
